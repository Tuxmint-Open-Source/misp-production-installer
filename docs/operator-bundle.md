...
The full source checkout remains the contributor and development path. Until an immutable tagged bundle has passed the complete artifact-level lifecycle validation matrix, the bundle is not the recommended production installation path.
