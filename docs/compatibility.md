...
| --- | ---: | ---: | ---: | --- | --- | --- |
| `v1.0.0-rc.2` release candidate | `v2.5.43` | `v3.0.8` | `v1.2` | 🟡 Pending exact-tag validation | 2026-07-13 | pending release-candidate validation |
...
> [!IMPORTANT]
> The `v1.0.0-rc.2` release candidate is pending exact-tag validation after the project rename/rebrand. The latest validated compatible release candidate remains `v1.0.0-rc.1` for MISP core `v2.5.43`, modules `v3.0.8`, and guard `v1.2`.
>
