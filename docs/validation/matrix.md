...
| --- | ---: | ---: | ---: | --- | --- | --- | --- | --- | --- | --- |
| `v1.0.0-rc.2` release candidate | `v2.5.43` | `v3.0.8` | `v1.2` | 🟡 Pending exact-tag validation | pending | pending | pending | pending | pending | pending release-candidate validation |
