...
The current release candidate, `v1.0.0-rc.2`, has passed exact-tag validation after the project rename/rebrand. The repository keeps the **not production ready** warning until the final `v1.0.0` tag is prepared, published, and validated separately.
...
| Compatibility status | ✅ `v1.0.0-rc.2` validated compatible; final `v1.0.0` still pending |
...
| --- | --- | --- |
| Exact release-tag compatibility validation | ✅ passed for `v1.0.0-rc.2` | Must be repeated for final `v1.0.0`. |
