...
Usage:
  ./lifecycle/reset-installation.sh [options]
...
Examples:
  ...
  ./lifecycle/reset-installation.sh --install-dir /opt/misp-docker

  # Remove MISP resources and the install directory:
  ./lifecycle/reset-installation.sh --install-dir /opt/misp-docker --yes

  # If you used a custom Compose project name:
  ./lifecycle/reset-installation.sh --install-dir /srv/misp --project-name mymisp --yes
EOF
}
