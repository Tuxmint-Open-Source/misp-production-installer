...
class StaticRepoTests(unittest.TestCase):
    ...
    def test_release_docs_require_exact_tag_compatibility_validation(self):
        ...
        self.assertIn('Backup, restore, and rollback | 🟡 `v1.3.1` pending exact-tag evidence; ✅ `v1.3.0` exact-tag and packaged-artifact evidence', readiness)
        self.assertIn('Browser-facing login | 🟡 `v1.3.1` pending exact-tag evidence; ✅ `v1.3.0` exact-tag browser evidence', readiness)
        self.assertIn('No-lock-in Compose operation | 🟡 `v1.3.1` pending exact-tag evidence; ✅ `v1.3.0` exact-tag and packaged-artifact evidence', readiness)
        ...
        self.assertIn('No-lock-in behavior passed exact-tag and packaged-artifact validation for `v1.3.0`', deployment)
        self.assertIn('No-lock-in behavior passed exact-tag and packaged-artifact validation for `v1.3.0`', deployment)
    ...
    def test_security_policy_exists_and_guides_private_reporting(self):
        ...
        self.assertIn('`v1.3.1` | Current stable release line', security)
        self.assertIn('`v1.3.0` | Latest validated-compatible artifact', security)
    ...
    def test_v1_3_release_is_pending_and_v1_2_evidence_is_preserved(self):
        ...
        self.assertIn('🟡 Pending validation', readme)
        ...
        self.assertIn('| `v1.3.1` release tag | `v2.5.44` | `v3.0.9` | `v1.2` | 🟡 Pending validation | — | — |', compatibility)
        ...
        self.assertIn('| `v1.3.1` release tag | `v2.5.44` | `v3.0.9` | `v1.2` | 🟡 Pending validation | — | — | — | — | — | — |', matrix)
        ...
        self.assertEqual(channels['latest_validated'], 'v1.3.0')
