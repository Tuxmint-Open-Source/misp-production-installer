...
class StaticRepoTests(unittest.TestCase):
    ...
    def test_release_docs_require_exact_tag_compatibility_validation(self):
        ...
        self.assertIn('Backup, restore, and rollback | ✅ `v1.3.0` exact-tag and packaged-artifact evidence', readiness)
        self.assertIn('Browser-facing login | ✅ `v1.3.0` exact-tag browser evidence', readiness)
        self.assertIn('No-lock-in Compose operation | ✅ `v1.3.0` exact-tag and packaged-artifact evidence', readiness)
    ...
    def test_security_policy_exists_and_guides_private_reporting(self):
        ...
        self.assertIn('`v1.3.0` | Current stable release line and latest validated-compatible artifact', security)
