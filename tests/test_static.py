...
class StaticRepoTests(unittest.TestCase):
    ...
    def test_release_docs_require_exact_tag_compatibility_validation(self):
        ...
        self.assertIn('Backup, restore, and rollback | 🟡 `v1.2.0` pending; ✅ `v1.1.0` exact-tag evidence', readiness)
        self.assertIn('Browser-facing login | 🟡 `v1.2.0` pending; ✅ `v1.1.0` exact-tag browser evidence', readiness)
        self.assertIn('No-lock-in Compose operation | 🟡 `v1.2.0` pending; ✅ `v1.1.0` exact-tag evidence', readiness)
        ...
        self.assertIn('latest published tag completes validation', deployment)
    ...
    def test_security_policy_exists_and_guides_private_reporting(self):
        ...
        self.assertIn('`v1.2.0` | Current stable release line; exact-tag compatibility', security)
        self.assertIn('`v1.1.0` | Latest validated-compatible artifact', security)
    ...
    def test_v1_2_release_is_pending_and_v1_1_evidence_is_preserved(self):
        ...
        self.assertIn('🟡 Pending validation', compatibility)
        ...
        self.assertIn('🟡 Pending validation', matrix)
        ...
        self.assertIn('`v1.2.0` pending exact-tag validation', readiness)
